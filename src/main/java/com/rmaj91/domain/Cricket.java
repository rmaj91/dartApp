...
//
//    @Override
//    public void goToNextPlayerOrRound() {
//        saveThrowFields();
...
//
//        if( currentPlayer != 1 && gamesRepositoryImpl.getNumberOfRound(this) != 0)
//            return;
//        if (gamesRepositoryImpl.getNumberOfRound(this) == 0){
...
//    @Override
//    public void displayRoundState() {
//        int currentRound = gamesRepositoryImpl.getNumberOfRound(this)+1;
...
//        if(gamesRepositoryImpl.getNumberOfRound(this)+1 < Cricket.roundsMaxNumber || currentPlayer != playersQuantity){
...
//            gamesRepositoryImpl.getCurrentRound().displayRoundState();
//        }
//
//    }
//
...
//        if(gamesRepositoryImpl.getNumberOfRound(this) > 0 || currentPlayer != 1){
//            if(currentPlayer == 1){
